...
/**
 * <p>Java class for setOfficialResult complex type</p>.
 * 
    ...
    extends Result
{
    ...
    public SetOfficialResult withErrors(Error... values) {
        if (values!= null) {
    ...
    public SetOfficialResult withErrors(Collection<Error> values) {
        if (values!= null) {
    ...
    public SetOfficialResult withWarnings(Warning... values) {
        if (values!= null) {
    ...
    public SetOfficialResult withWarnings(Collection<Warning> values) {
        if (values!= null) {
    ...
    @Override
    public SetOfficialResult withSuccess(boolean value) {
        setSuccess(value);
        return this;
    }
