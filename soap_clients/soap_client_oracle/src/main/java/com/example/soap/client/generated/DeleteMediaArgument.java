...
/**
 * <p>Java class for deleteMediaArgument complex type</p>.
 * 
...
public class DeleteMediaArgument {
    ...
    public DeleteMediaArgument withMediaGuid(String value) {
        setMediaGuid(value);
        return this;
    }

    public DeleteMediaArgument withMediaHash(String value) {
        setMediaHash(value);
        return this;
    }
