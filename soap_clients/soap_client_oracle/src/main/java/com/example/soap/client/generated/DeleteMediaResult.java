...
/**
 * <p>Java class for deleteMediaResult complex type</p>.
 * 
    ...
    extends Result
{
    ...
    public DeleteMediaResult withErrors(Error... values) {
        if (values!= null) {
    ...
    public DeleteMediaResult withErrors(Collection<Error> values) {
        if (values!= null) {
    ...
    public DeleteMediaResult withWarnings(Warning... values) {
        if (values!= null) {
    ...
    public DeleteMediaResult withWarnings(Collection<Warning> values) {
        if (values!= null) {
    ...
    @Override
    public DeleteMediaResult withSuccess(boolean value) {
        setSuccess(value);
        return this;
    }
